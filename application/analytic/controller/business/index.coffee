_config = ($stateProvider) ->
  $stateProvider.state "analytic.business",
    url : "/business"
    templateUrl  : '/template/analytic/controller/business/view.html'
    controller: 'analytic.controller.business.Ctrl'
...
.config _config
.run _run
.controller 'analytic.controller.business.Ctrl', _controller
