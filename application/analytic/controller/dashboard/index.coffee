_config = ($stateProvider) ->
  $stateProvider.state "analytic.dashboard",
    url : "/dashboard"
    templateUrl  : '/template/analytic/controller/dashboard/view.html'
    controller: 'analytic.controller.dashboard.Ctrl'
...
.config _config
.run _run
.controller 'analytic.controller.dashboard.Ctrl', _controller
